...
- Name: performance.spec.ts >> Performance Lite Tests @performance >> Repeated GET accounts 5 times asynchronously
...
```ts
  ...
  23 |   });
  24 | 
  25 |   test('Repeated GET accounts 5 times asynchronously', async ({ userAPI }) => {
  26 | 
