...
- Name: performance.spec.ts >> Performance Lite Tests @performance >> UI page load time should be reasonable
- Location: tests\performance.spec.ts:45:7
...
Call log:
  - navigating to "http://localhost:1010/parabank/index.htm", waiting until "load"
